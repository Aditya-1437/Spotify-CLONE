...
const Player = () => {
    ...
    const {seekBar,seekBg,playStatus,play,pause,track,time,prev,next} = useContext(PlayerContext);

  return (
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        <div className="hidden lg:flex items-center gap-4">
            <img className='w-12' src={track.image} alt="playlist" />
            <div className="">
                <p>{track.name}</p>
        ...
        <div className="flex flex-col items-center gap-1 m-auto">
            <div className="flex gap-4">
                <img className='w-4 cursor-pointer' src={assets.shuffle_icon} alt="shuffel" />
